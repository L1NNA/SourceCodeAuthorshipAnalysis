...
#                         help="path to validation data file", required=True)
    parser.add_argument("-vd", "--data_file", dest="data_file_path",
                        help="path to all data file", required=True)
...
#     for data_file_path, data_role in zip([test_data_path, val_data_path, train_data_path], ['test', 'val', 'train']):
    num_examples = process_file(file_path=data_file_path, data_file_role='test', dataset_name=args.output_name,
