...
TRAIN_DIR='/content/drive/My Drive/Projects/1_Verification_Sourcecode_Siamese/data_gen/data_GCJ/c2v/new_experiment/java/train/'
VAL_DIR='/content/drive/My Drive/Projects/1_Verification_Sourcecode_Siamese/data_gen/data_GCJ/c2v/new_experiment/java/vali/'
TEST_DIR='/content/drive/My Drive/Projects/1_Verification_Sourcecode_Siamese/data_gen/data_GCJ/c2v/new_experiment/java/test/'

DATASET_NAME=my_java_data
MAX_CONTEXTS=200
