...
class SiameseBiLSTM:
    ...
    def train_model(self, sentences_pair, is_similar, embedding_meta_data, language, model_save_directory='./'):
        ...
        print('custom_loss self-define lr=0.00001')
        nadam = keras.optimizers.Nadam(lr=0.00001, beta_1=0.9, beta_2=0.999)
        #model = Model(inputs=[sequence_1_input, sequence_2_input, leaks_input], outputs=cos_sim)
        model = Model(inputs=[sequence_1_input, sequence_2_input], outputs=cos_sim)
